...
np.save('zeb2wild/rho_e.npy',M.trace('rho_e')[:])
np.save('zeb2wild/rho_m.npy',M.trace('rho_m')[:])
np.save('zeb2wild/rho_s.npy',M.trace('rho_s')[:])
...
np.save('zeb2wild/ignore_length.npy',M.trace('ignore_length')[:])
