...
interaction_length = Uniform('interaction_length', lower=0.5, upper=20.0,value=6.612)
decay_exponent = Uniform('decay_exponent', lower=0.5, upper=50.0,value=20.8537)
